...
{
    public partial class AR_ChangeOrder_F : Form
    {
        public AR_ChangeOrder_F(Order TempOrder)
        {
        ...
        private void ARChangeOrder_F_FormClosing(object sender, FormClosingEventArgs e)
        {
