...
{
    public partial class Design_Engineer_ChangeOrder_F : Form
    {
        public Design_Engineer_ChangeOrder_F(Order TempOrder)
        {
        ...
        private void Design_Engineer_ChangeOrder_F_FormClosing(object sender, FormClosingEventArgs e)
        {
