...
using SZMK.TeklaInteraction.Tekla21_1.Views.Main;
using SZMK.TeklaInteraction.Tekla21_1.Views.Shared.Interfaces;
using Tekla.Structures.Drawing;
using Tekla.Structures.Model;
using Tekla_Interaction.Tekla21_1.Views.Main;
...
namespace SZMK.TeklaInteraction.Tekla21_1.Services.Server
{
    class Tekla : ITekla
    {
        ...
        SZMK.TeklaInteraction.Shared.Models.Model Model;
        public List<SZMK.TeklaInteraction.Shared.Models.Drawing> Drawings;
